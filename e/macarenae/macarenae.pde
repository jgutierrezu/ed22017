...
// Examen 
/* Tres visualizaciones del clima de la cicudad La Rochelle, France durente el año 2015
que van de lo general a lo especifico. La primera visualización es de la humedad durante
todo el año (tecla z). La segunda es de la temperatura en las estaciones, invierno 
(tecla a), primavera (tecla s), verano (tecla d) y otoño (tecla f). Y la ultima es una 
comparacion entre el punto de rocio y la visibilidad durenate cada mes de ese año 
