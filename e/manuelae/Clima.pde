class Clima { //Clase
  ...
  /*Función temperaturaMax, que dibujara las lineas correspondientes a diferentes dias
  ...
  /*Función Enero, que dibujara las lineas y puntoscorrespondientes a diferentes
  ...
  /*Función Febrero, que dibujara las lineas y puntoscorrespondientes a diferentes
   dias segun distintas variables.*/
  void febrero() {    
    pushMatrix();
    textAlign(CENTER);
  ...
  /*Función Marzo, que dibujara las lineas y puntoscorrespondientes a diferentes
   dias segun distintas variables.*/
  void marzo() {
    pushMatrix();
    textAlign(CENTER);
  ...
  /*Función Abril, que dibujara las lineas y puntoscorrespondientes a diferentes
   dias segun distintas variables.*/
  void abril() {    
    pushMatrix();
    textAlign(CENTER);
  ...
  /*Función Mayo, que dibujara las lineas y puntoscorrespondientes a diferentes
   dias segun distintas variables.*/
  void mayo() { 
    pushMatrix();
    textAlign(CENTER);
  ...
  /*Función Junio, que dibujara las lineas y puntoscorrespondientes a diferentes
   dias segun distintas variables.*/
  void junio() {
    pushMatrix();
    textAlign(CENTER);
  ...
  /*Funcion Julio, que dibujara las lineas y puntoscorrespondientes a diferentes
   dias segun distintas variables.*/
  void julio() {
    pushMatrix();
    textAlign(CENTER);
  ...
  /*Función Agosto, que dibujara las lineas y puntoscorrespondientes a diferentes
   dias segun distintas variables.*/
  void agosto() {
    pushMatrix();
    textAlign(CENTER);
  ...
  /*Función Septiembre, que dibujara las lineas y puntoscorrespondientes a diferentes
   dias segun distintas variables.*/
  void septiembre() {
    pushMatrix();
    textAlign(CENTER);
  ...
  /*Funcion Octubre, que dibujara las lineas y puntoscorrespondientes a diferentes
   dias segun distintas variables.*/
  void octubre() {
    pushMatrix();
    textAlign(CENTER);
  ...
  /*Funcion Noviembre, que dibujara las lineas y puntoscorrespondientes a diferentes
   dias segun distintas variables.*/
  void noviembre() {
    pushMatrix();
    textAlign(CENTER);
  ...
  /*Función Diciembre, que dibujara las lineas y puntoscorrespondientes a diferentes
   dias segun distintas variables.*/
  void diciembre() {
    pushMatrix();
    textAlign(CENTER);
